 ...
 return <main>
  ...
  <section className="hero" id="quiz">
   ...
   <div className="wrap heroGrid">
    <div className="heroCopy"><p className="eyebrow">{t('PEOPLE. IDEAS. A BRIGHTER TOMORROW.','MENSCHEN. IDEEN. EINE BESSERE ZUKUNFT.')}</p><h1>{t('Different views. A stronger tomorrow.','Verschiedene Ansichten. Eine stärkere Zukunft.')}</h1><div className="rule"/><p className="lede">{t('Explore your political angle, understand the bigger picture, and be part of a more open conversation.','Entdecken Sie Ihre politische Perspektive, verstehen Sie das Gesamtbild und werden Sie Teil eines offeneren Gesprächs.')}</p><a className="button dark heroButton" href="/quiz">{t('Take the Quiz','Test starten')} <span>→</span></a><p className="micro">{t('26 questions · about 3 minutes · free','26 Fragen · etwa 3 Minuten · kostenlos')}</p></div>
