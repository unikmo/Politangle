...
export default async function SchoolProjectorPage({ searchParams }: { searchParams: Promise<{ code?: string }> }) {
  ...
  return (
    <main className="engine-page school-page school-projector-page">
      <header className="engine-header no-print"><Link href="/school" className="engine-brand">Politangle School</Link><span>Classroom projector</span><LanguageSelector /></header>
