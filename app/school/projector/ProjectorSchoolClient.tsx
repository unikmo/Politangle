...
type PublicRoom = {
  ...
  revealed: boolean;
  currentQuestion: { id: string; kind: 'believe' | 'literacy'; title: string; statement?: string; prompt?: string; explanation?: string } | null;
