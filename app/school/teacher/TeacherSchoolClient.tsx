  ...
  const configuration = (
    <article className="engine-card school-config-card">
      ...
      <div className="school-config-grid">
        ...
        <label><span>Activity</span><select value={activityType} onChange={(e) => setActivityType(e.target.value as typeof activityType)}>{ageBand === 'junior-10-13' ? <option value="junior">Junior 32</option> : <><option value="quick26">Youth Quick 26</option><option value="full42">Youth Full 84</option></>}<option value="literacy">Political Literacy Quiz</option><option value="guided">Guided Lesson</option><option value="custom">Build my own / single question</option></select></label>
