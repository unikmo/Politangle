...
export default function PrivateLiteracyHeader() {
  ...
  const label = locale === 'de' ? 'Politisches Wissen · privat' : locale === 'es' ? 'Conocimientos políticos · privado' : locale === 'fr' ? 'Culture politique · privé' : locale === 'pt-br' ? 'Conhecimento político · privado' : 'Private political literacy';
