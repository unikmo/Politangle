    ...
    <main className="engine-page school-page">
      ...
      <section className="engine-shell school-shell">
        ...
        <div className="school-entry-grid">
          <article className="engine-card school-entry-card"><p className="engine-kicker">BELIEVE</p><h2>Quick 52</h2><p>{t('Start with 52 single statements and see your broad multidimensional political shape.','Beginnen Sie mit 52 einzelnen Aussagen und sehen Sie Ihre mehrdimensionale politische Form.')}</p><Link className="engine-primary-link" href="/quiz">{t('Start Quick 52','Quick 52 starten')}</Link></article>
