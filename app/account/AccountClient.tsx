...
const copy: Record<Locale, Copy> = {
  ...
  'pt-br': {
    freeAccount:'CONTA GRATUITA', repeatTitle:'Crie uma conta gratuita para fazer o Quick novamente.', repeatIntro:'Seu primeiro Quick pode ser feito sem conta. A partir da segunda vez, entre ou crie uma conta gratuita. Suas respostas do BELIEVE continuam no seu navegador e não são adicionadas à conta.',
    title:'Sua conta Politangle', intro:'O cadastro é gratuito. Use a mesma conta para repetir avaliações, acessar a certificação de conhecimentos e consultar seus certificados.', secure:'CONTA',
    signIn:'Entrar', create:'Criar conta', email:'E-mail', password:'Senha', createButton:'Criar conta gratuita', signInButton:'Entrar',
    noPayment:'Não é preciso pagar para se cadastrar. O certificado é um produto pago separado, disponível somente depois de passar na prova certificada.', existing:'Já tem uma conta? Entre', need:'Precisa de uma conta? Crie uma', forgot:'Esqueceu a senha?', signedOut:'Sessão encerrada.', accountCreated:'Conta criada. Verifique seu e-mail quando puder.', signedIn:'Sessão iniciada com segurança.',
    verified:'E-mail verificado', adult:'Certificação 16+', yes:'Sim', notYet:'Ainda não', certificates:'Seus certificados', noCertificates:'Nenhum certificado foi emitido para esta conta.', continue:'Continuar', certificationCheck:'Confirmo que tenho pelo menos 16 anos para a certificação.', confirmCertificationAge:'Confirmar 16+ para certificação', certificationNote:'A conta gratuita não tem restrição de 16+. A confirmação de idade vale apenas para a certificação.', signOut:'Sair', resetSent:'Se existir uma conta com esse endereço, um e-mail para redefinir a senha foi enviado.', wait:'Aguarde…',
  },
};
