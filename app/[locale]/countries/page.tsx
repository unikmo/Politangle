...
const copy = {
  de: { eyebrow:'LÄNDERPERSPEKTIVEN', title:'Gleiche politische Begriffe. Anderer Länderkontext.', intro:'Alle 40 Länderperspektiven sind auf Deutsch verfügbar. Sie erklären nur den Kontext, der nötig ist, bevor politische Begriffe und Institutionen zwischen Ländern verglichen werden.', open:'Öffnen', note:'Aktuelle Momentaufnahmen erscheinen nur dort, wo die zugrunde liegenden Daten bereits quellengeprüft wurden.', metaTitle:'Länderperspektiven', metaDescription:'Politangle erklärt, wie politische Begriffe und Institutionen in 40 Ländern unterschiedlich funktionieren.', cardLabel:'KONTEXTLEITFADEN' },
  es: { eyebrow:'PERSPECTIVAS NACIONALES', title:'Las mismas palabras políticas. Otro contexto nacional.', intro:'Las 40 perspectivas nacionales están disponibles en español. Explican solo el contexto necesario antes de comparar etiquetas e instituciones políticas entre países.', open:'Abrir', note:'Los panoramas políticos actuales aparecen solo cuando los datos de base ya han sido verificados con fuentes.', metaTitle:'Perspectivas nacionales', metaDescription:'Politangle explica cómo cambian las etiquetas políticas y las instituciones en 40 países.', cardLabel:'GUÍA DE CONTEXTO' },
  fr: { eyebrow:'PERSPECTIVES NATIONALES', title:'Les mêmes mots politiques. Un autre contexte national.', intro:'Les 40 perspectives nationales sont disponibles en français. Elles donnent uniquement le contexte nécessaire avant de comparer les étiquettes et institutions politiques entre pays.', open:'Ouvrir', note:'Les instantanés politiques actuels n’apparaissent que lorsque les données sous-jacentes ont déjà été vérifiées par des sources.', metaTitle:'Perspectives nationales', metaDescription:'Politangle explique comment les étiquettes politiques et les institutions diffèrent dans 40 pays.', cardLabel:'GUIDE DE CONTEXTE' },
  'pt-br': { eyebrow:'PERSPECTIVAS POR PAÍS', title:'As mesmas palavras políticas. Outro contexto nacional.', intro:'As 40 perspectivas por país estão disponíveis em português do Brasil. Elas apresentam o contexto necessário antes de comparar rótulos políticos e instituições entre países.', open:'Abrir', note:'Panoramas políticos atuais só aparecem quando os dados de base já passaram por verificação de fontes.', metaTitle:'Perspectivas por país', metaDescription:'O Politangle explica como rótulos políticos e instituições funcionam de forma diferente em 40 países.', cardLabel:'GUIA DE CONTEXTO' },
} as const;
