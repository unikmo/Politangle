...
const copy = {
  de: { eyebrow:'LÄNDERPERSPEKTIVEN', title:'Gleiche politische Begriffe. Anderer Länderkontext.', intro:'Alle 80 Länderperspektiven sind auf Deutsch verfügbar. Sie erklären nur den Kontext, der nötig ist, bevor politische Begriffe und Institutionen zwischen Ländern verglichen werden.', open:'Öffnen', note:'Aktuelle Momentaufnahmen erscheinen nur dort, wo die zugrunde liegenden Daten bereits quellengeprüft wurden.', metaTitle:'Länderperspektiven', metaDescription:'Politangle erklärt, wie politische Begriffe und Institutionen in 80 Ländern unterschiedlich funktionieren.', cardLabel:'KONTEXTLEITFADEN' },
  ...
  fr: { eyebrow:'PERSPECTIVES NATIONALES', title:'Les mêmes mots politiques. Un autre contexte national.', intro:'Les 80 perspectives nationales sont disponibles en français. Elles donnent uniquement le contexte nécessaire avant de comparer les étiquettes et institutions politiques entre pays.', open:'Ouvrir', note:'Les instantanés politiques actuels n’apparaissent que lorsque les données sous-jacentes ont déjà été vérifiées par des sources.', metaTitle:'Perspectives nationales', metaDescription:'Politangle explique comment les étiquettes politiques et les institutions diffèrent dans 80 pays.', cardLabel:'GUIDE DE CONTEXTE' },
