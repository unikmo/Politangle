...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const languages = { 'en-US': 'https://politangle.org/en', de: 'https://politangle.org/de', es: 'https://politangle.org/es', fr: 'https://politangle.org/fr' };
  return routes.flatMap((route) => ['en', 'de', 'es', 'fr'].map((locale) => ({
