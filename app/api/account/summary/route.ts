...
export async function GET() {
  ...
  return NextResponse.json({ emailVerified: user.emailVerified, adultConfirmed: user.adultConfirmed, isAdmin: user.isAdmin, certificates }, { headers: { 'Cache-Control': 'no-store' } });
}
