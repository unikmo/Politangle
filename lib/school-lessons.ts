...
export const schoolLessons: readonly SchoolLesson[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { minutes: '10–30', teacher: 'Run pluralism and populism BELIEVE triplets.', students: 'Answer anonymously and inspect the distributions.' },
      { minutes: '30–45', teacher: 'Run the literacy questions and reveal explanations.', students: 'Distinguish people-versus-elite populism from weakening democratic checks.' },
