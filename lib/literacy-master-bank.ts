...
const addedClassifyCandidates: readonly LiteracyQuestionRecord[] = [
  ...
  asCandidate({
    ...
    prompt: 'A thinker says governments have no automatic moral right to command. Political authority must always justify itself. Which tradition fits best?',
    options: [
      { id: 'anarchism', label: 'Anarchism' },
      { id: 'federalism', label: 'Federalism' },
      { id: 'conservatism', label: 'Conservatism' },
    ...
    acceptedAnswerSets: [['anarchism']],
    explanation: 'Anarchism questions whether governments have a general right to command. This does not require one particular economic model.',
    evidenceIds: ['SEP-ANARCHISM'],
  }, { blueprintBucket: 'anarchism_other', difficulty: 'advanced', secondaryTags: ['anarchism', 'political-authority', 'legitimacy'] }),
  asCandidate({
