...
const prompts: Record<string, string> = {
  ...
  C5: 'Eine Bewegung unterstützt Privateigentum und Marktwirtschaft, bevorzugt schrittweisen gesellschaftlichen Wandel und akzeptiert Wohlfahrt oder Regulierung, wenn sie sozialen Zusammenhalt stärken. Welche breite Tradition passt am besten?',
  ...
  C9: 'Eine Bewegung misst der Nation besonderen politischen Wert bei und fordert weitgehende Selbstbestimmung, sagt aber nichts über Wirtschaft oder Sozialpolitik. Welche politische Idee passt am besten?',
...
const explanations: Record<string, string> = {
  ...
  C5: 'Konservatismus muss keinen Minimalstaat bedeuten. Konservative Traditionen können Wohlfahrt, Regulierung und soziale Pflichten akzeptieren und zugleich Privateigentum, Kontinuität und schrittweisen Wandel betonen.',
