...
export const deExtra: Record<string, LocalizedCountryContent> = {
  ...
  india: {
    ...
    power: [
      ...
      "Die Verfassung teilt Zuständigkeiten zwischen Union und Bundesstaaten, gibt der Union aber wichtige Vorrang- und Notstandsbefugnisse. Der Supreme Court kann Gesetze prüfen und die Grundstruktur der Verfassung schützen.",
    ],
    vocabulary: [
  ...
  nigeria: {
    name: "Nigeria",
    atAGlance: [["System","Föderale präsidentielle Republik"],["Exekutive","Präsident"],["Legislative","Nationalversammlung: Repräsentantenhaus und Senat"],["Gerichte","Supreme Court sowie Bundes- und Staatsgerichte"],["Territorialstruktur","Föderal: 36 Bundesstaaten und Federal Capital Territory"]],
    power: [
  ...
  philippines: {
    name: "Philippinen",
    atAGlance: [["System","Einheitsstaatliche präsidentielle Republik"],["Exekutive","Präsident"],["Legislative","Kongress: Repräsentantenhaus und Senat"],["Gerichte","Supreme Court und untergeordnete Gerichte"],["Territorialstruktur","Einheitsstaat mit gewählten Kommunalregierungen und einer autonomen Bangsamoro-Region"]],
    power: [
      ...
      "Der Supreme Court entscheidet Verfassungsstreitigkeiten. Unabhängige Verfassungskommissionen überwachen Wahlen, öffentlichen Dienst und staatliche Rechnungsprüfung; Kommunalregierungen üben vom nationalen Recht übertragene Befugnisse aus.",
    ],
    vocabulary: [
    ...
    timeline: [
      ...
      { year:"1986", title:"People-Power-Übergang", text:"Massenproteste und eine umstrittene Wahl beendeten die Marcos-Präsidentschaft und stellten wettbewerbliche demokratische Regierung wieder her." },
...
export const esExtra: Record<string, LocalizedCountryContent> = {
  ...
  philippines: {
    ...
    timeline:[{year:"1946",title:"Independencia",text:"Filipinas se convirtió en república independiente tras el dominio colonial y la ocupación durante la guerra."},{year:"1972",title:"Ley marcial",text:"El presidente Ferdinand Marcos declaró la ley marcial, concentrando poder y restringiendo oposición y libertades civiles."},{year:"1986",title:"Transición de People Power",text:"Las protestas masivas y una elección disputada pusieron fin a la presidencia de Marcos y restauraron un gobierno democrático competitivo."},{year:"1987",title:"Constitución vigente",text:"Una nueva Constitución restauró controles y contrapesos, protección de derechos y límites de mandato presidencial."}],
  },
  brazil: {
    name:"Brasil",
