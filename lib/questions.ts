...
export const QUICK_QUESTIONNAIRE_VERSION = 'quick-2026.09-v1' as const;
...
export const answerOptions: readonly { label: string; value: AnswerValue; scored: boolean }[] = [
  { label: 'Strongly disagree', value: -2, scored: true },
  { label: 'Somewhat disagree', value: -1, scored: true },
  { label: 'Not sure / I do not understand', value: 0, scored: false },
  { label: 'Somewhat agree', value: 1, scored: true },
